...
<div class="container text-center">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item">
                <a class="page-link" href="/urna_eletronica" tabindex="-1" aria-disabled="true">Home</a>
            </li>
            <li class="page-item">
                <a class="page-link" href="/urna_eletronica/criarInfra">Criar Infraestrutura</a>
            </li>
            <li class="page-item disabled">
                <a class="page-link" href="/urna_eletronica/votacao">Votação</a>
            </li>
            <li class="page-item">
                <a class="page-link" href="/urna_eletronica/relatorios">Relatórios</a>
            </li>
        </ul>
    </nav>
            ...
            <div class="mb-2">
                <form id="form-voto" method="post" action="">
                    <div class="form-group">
                        <label>Digite seu identificador abaixo.</label>
                        <input id="identificador" name="identificador" class="w-100" type="title" placeholder="RG"
                               value="">
                        <small id="identificador-help" class="form-text text-muted">Lembre-se de escrevê-lo
                            corretamente, ou seu voto não será contabilizado.</small>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Abaixo está o número de seu candidato.</label>
                        <input id="painel" name="painel" class="form-control w-100" type="title"
